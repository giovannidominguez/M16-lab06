package edu.ucsb.cs56.drawings.giovannidominguez.simple;
...
Circle snowManTopCircle = new Circle
    (
	snowManCenterBottomX,
	snowManCenterBottomY-bottomRadius*3-2*topRadius,
	topRadius
     );
g2.draw(snowManTopCircle);	
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Your Friendly Neighborhood Snowman - Giovanni Dominguez", 20,20);
