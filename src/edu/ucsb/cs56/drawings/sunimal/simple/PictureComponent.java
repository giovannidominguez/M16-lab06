package edu.ucsb.cs56.drawings.sunimal.simple;
...
public class PictureComponent extends JComponent {
	...
	/**
	 * The paintComponent method is always required if you want any graphics to
	 * appear in your JComponent.
	 * 
	 * There is a paintComponent method that is created for you in the
	 * JComponent class, but it doesn't do what we want, so we have to
	 * "override" that method with our own method.
	 * 
	 * This overriding is typical when inheritance is used. In inheritance, you
	 * take something that is a "basic" version of what you want, then you
	 * "trick it out" with your own custom features. Sort of a "pimp my Java
	 * class" kind of thing.
	 */
	...
	public void paintComponent(Graphics g) {
		...
		Circle snowManBottomCircle = new Circle(snowManCenterBottomX, snowManCenterBottomY - bottomRadius,
				bottomRadius);
		g2.draw(snowManBottomCircle);

		Circle snowManMiddleCircle = new Circle(snowManCenterBottomX,
				snowManCenterBottomY - bottomRadius * 2 - middleRadius, middleRadius);
