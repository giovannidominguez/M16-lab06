 ...
 * 
 * This provides an example of how you can start with the coordinates of a hard
 * coded object, and end up with an object that can be drawn anywhere, with any
 * width or height.
 * 
 * @author Phill Conrad
...
public class CoffeeCup extends GeneralPathWrapper implements Shape {
	...
	public CoffeeCup(double x, double y, double width, double height) {
		...
		// translate to the origin by subtracting the original upper left x and
		// y
